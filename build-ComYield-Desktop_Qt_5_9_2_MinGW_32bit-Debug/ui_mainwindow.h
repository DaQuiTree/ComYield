...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        if (panelTable->columnCount() < 4)
            panelTable->setColumnCount(4);
        ...
        panelTable->setHorizontalHeaderItem(3, __qtablewidgetitem3);
        ...
        panelTable->setItem(0, 0, __qtablewidgetitem4);
        panelTable->setObjectName(QStringLiteral("panelTable"));
        panelTable->setMinimumSize(QSize(441, 241));
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "\351\230\277\350\217\262\351\207\221\345\245\266\351\207\217\346\250\241\346\213\237", Q_NULLPTR));
        ...
        QTableWidgetItem *___qtablewidgetitem3 = panelTable->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("MainWindow", "\346\225\205\351\232\234", Q_NULLPTR));
